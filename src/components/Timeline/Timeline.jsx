      ...
      <section className='timeline-web'>
        <div className="now container">
          <div className="content  column">
            ...
            <p>English tutor - online since 2019</p>
              <div className='detail column'>
                <p>I have taught Polish high-school students and adults</p>
                <p>At the moment, I teach two students.</p>
              </div>
          </div>
        </div>
        ...
        <div className="next container">
          <div className="content">
            <p>Explore Tailwind library</p>
            <p>Explore C++ on freecodecamp</p>
            <p>Explore vue.js</p>
            <p>Complete Freecodecamp</p>
          </div>
        </div>
        <div className='flex-done'>
          ...
          <div className='jobs-left'>
            <div className="done container newchem2">
              <div className="content">
                <p>(acquired by by Sterling Pharma Solutions)</p>
